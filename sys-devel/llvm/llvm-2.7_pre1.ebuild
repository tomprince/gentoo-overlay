...
SRC_URI="http://llvm.org/pre-releases/${MY_PV}/pre-release1/${PN}-${MY_PV}.tar.gz"

LICENSE="UoI-NCSA"
SLOT="0"
KEYWORDS="~amd64 ~ppc ~x86"
IUSE="alltargets debug +libffi llvm-gcc ocaml test shared"
...
src_configure() {
	...
	CONF_FLAGS="${CONF_FLAGS} $(use_enable libffi) $(use_enable shared)"
